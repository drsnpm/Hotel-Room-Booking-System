...
const ExistingRooms = () => {
	...
	const handleDelete = async (roomId) => {
		const confirmDelete = window.confirm(`Are you sure you want to delete Room No ${roomId}?`)
								...
								<tr key={room.id} className="text-center">
									...
									<td>
										<div className="d-flex justify-content-center">
											<Link to={`/edit-room/${room.id}`} className="me-2">
												<button className="btn btn-info btn-sm" title="View">
													<FaEye />
												</button>
											</Link>
